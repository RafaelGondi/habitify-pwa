...
<template>
  <div class="flex flex-col h-full overflow-y-auto">
    <!-- Header -->
    <header class="sticky top-0 z-10 bg-zinc-100/95 dark:bg-zinc-900/95 backdrop-blur-sm border-b border-default px-4" style="padding-top: env(safe-area-inset-top, 0px)">
